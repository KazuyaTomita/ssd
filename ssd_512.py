...
def SSD512(input_shape, num_classes=1, featurte_map=None):
    """SSD300 architecture.
    ...
    with tf.name_scope("Block6"):
        conv6_1 = Conv2D(256, (1, 1),
                         ...
                         padding='same',
                         activation='relu')(fc7)
        conv6_1z = ZeroPadding2D(padding=((1, 1), (1, 1)), name='conv6_padding')(conv6_1)
    ...
    with tf.name_scope("Block8"):
        ...
        conv8_1z = ZeroPadding2D(padding=((1, 1), (1, 1)), name='conv8_padding')(conv8_1)
        conv8_2 = Conv2D(256, (3, 3),
                         name='conv8_2',
                         padding='valid',
                         strides=(2, 2),
                         activation='relu')(conv8_1z)
    ...
    with tf.name_scope("Block9"):
        ...
        conv9_1z = ZeroPadding2D(padding=((1, 1), (1, 1)), name='conv9_padding')(conv9_1)
        conv9_2 = Conv2D(256, (3, 3),
                         strides=(2, 2),
                         activation='relu',
                         padding='valid',
                         name='conv9_2')(conv9_1z)
    ...
    with tf.name_scope("Block10"):
        ...
        conv10_1z = ZeroPadding2D(padding=((1, 1), (1, 1)), name='conv10_padding')(conv10_1)
        conv10_2 = Conv2D(256, (4, 4),
                          strides=(1, 1),
                          activation='relu',
                          padding='valid',
                          name='conv10_2')(conv10_1z)

    # number of prediction layers is 7.
    ...
    if num_classes != 21:
        name += '_{}'.format(num_classes)
    with tf.name_scope("conv10_2"):
        conv10_2_mbox_conf = Conv2D(num_priors * num_classes, (3, 3),
                                   padding='same',
                                   name=name)(conv10_2)
        conv10_2_mbox_conf_flat = Flatten(name='conv10_2_mbox_conf_flat')(conv10_2_mbox_conf)
        conv10_2_mbox_loc = Conv2D(num_priors * 4, (3, 3),
                                  padding='same',
